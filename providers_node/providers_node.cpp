...
int main(int argc, char **argv){
    ...
    Threshold_status* threshold_x = new Threshold_status(0.4, 0.05, 0.01, CAMERA_FREQUENCY);
    Threshold_status* threshold_z = new Threshold_status(0.4, 0.05, 0.01, CAMERA_FREQUENCY);
